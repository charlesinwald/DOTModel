...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  public static StringBuilder str_log = new StringBuilder();

  private FusedLocationProviderClient mFusedLocationClient;

  private float longtitude,latitude,speed;

  private long t_img,t_int;

  private long t_acc = MainPage.t_acc;
              ...
              public void run() {
                ...
                for (final Classifier.Recognition result : results) {
                  ...
                  if (location != null && result.getConfidence() >= minimumConfidence) {
                    ...
                    if(speed!=0 && t_acc!=0){
                      count = (int)(2*(5/speed)/t_acc);
                    }

//                    t_int = System.currentTimeMillis();
    ...
    //                dataMap.put(data, show);
                    ...
                    str_log.append(longtitude).append(" ").append(latitude).append(" ").append(result.getConfidence()).append("\n");
                  }
                }
